...
public class MyDialog extends Dialog implements View.OnClickListener {
    private android.support.v7.widget.Toolbar view;
    private android.widget.Button closeDialogButton;

    private onClickCloseListener closeListener;
    private android.widget.EditText ssidEdit;
    private android.widget.EditText passwordEdit;
